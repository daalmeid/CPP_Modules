...
/*   Updated: 2022/06/02 14:33:36 by daalmeid         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::attack(const std::string& target) {
	...
	if (this->_EP > 0 && this->_HP > 0)
	{
		...
		std::cout << "ClapTrap " << this->_name << " tried to attack but cannot move!" << std::endl;
		return ;
}
...
void	ClapTrap:: beRepaired(unsigned int amount) {
	...
	if (this->_EP > 0 && this->_HP > 0)
	{
		this->_HP += amount;
		this->_EP--;
		std::cout << "ClapTrap " << this->_name << " repaired itself, regaining " << amount << " of health points!" << std::endl;
	}
	else
...
void	 ClapTrap::clapTrapStat(void) const {
	...
	std::cout << "ClapTrap " << this->_name << " status:" << std::endl << std::endl;
